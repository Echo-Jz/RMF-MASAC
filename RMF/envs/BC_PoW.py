...
class BC_PoW:
    ...
    def reset(self):
        self.states = np.zeros((self.num_agents, 3))
    ...
    def step(self, actions):
        ...
        # 主交易队列更新
        tranc = self.states[:, 2].reshape(-1, 1) + task_solve
        ...
        # 更新下一个状态
        next_state = np.concatenate((task_rev, task_next, tranc_next), axis=1)
        info = {}
        done = False
